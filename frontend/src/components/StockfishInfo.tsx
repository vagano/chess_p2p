import type { EvalResult } from '../lib/evaluation';
    ...
    return (
      <div style={containerStyle}>
        <div style={headerStyle}>
          <span style={iconStyle}>♟</span> Stockfish
        </div>
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '8px' }}>
        <span style={{ fontSize: '28px', fontWeight: 800, color: scoreColor, fontFamily: 'monospace' }}>
          {scoreText}
        </span>
        <span style={{ fontSize: '12px', color: verdictColor, fontWeight: 600 }}>
          {verdict}
        </span>
      </div>
        ...
        <div style={{ fontSize: '11px', fontFamily: 'monospace', lineHeight: 1.7 }}>
          {evalResult.bestMove && (
            <div style={rowStyle}>
              ...
              <span style={{ fontWeight: 700 }}>{evalResult.bestMove}</span>
            </div>
          )}
          <div style={rowStyle}>
            <span style={labelStyle}>Depth</span>
            <span>{evalResult.depth}</span>
          </div>
          <div style={rowStyle}>
